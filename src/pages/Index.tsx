                  ...
                  <CardHeader className="pb-4 relative">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className={`flex items-center space-x-1 text-sm font-bold ${metric.chart === 'trending-up' ? 'text-emerald-600' : metric.chart === 'trending-down' ? 'text-blue-600' : 'text-slate-600'}`}>
